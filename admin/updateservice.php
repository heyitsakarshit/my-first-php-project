...
if(isset($_POST["action"]))
{
  ...
  if($_POST["action"] == "update")
 {
  ...
  $query = "UPDATE services SET name='$fullname', description='$age', symptom='$symptom' WHERE id = '".$_POST["id"]."'";
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonlist"> 
                              <a class="btn btn-add " href="services.php"> 
                              <i class="fa fa-list"></i> View Service </a>  
                           </div>
                        </div>
                        <div class="panel-body">
                          <form enctype="multipart/form-data" method="post" action="services.php" class="col-sm-6">
                            ...
                            $con = mysqli_connect("localhost","drakpandey","Pandey@809","akpandey");   
                             $r="SELECT * FROM services WHERE id = '".$_GET["id"]."'";
                                $rr = mysqli_query($con,$r);
                                while($row= mysqli_fetch_array($rr))
                                {
                                    ?>
                                 <input type="text" name="name" class="form-control" placeholder="Enter Service Name"  value="<?php echo $row['name']; ?>">
                              ...
                              <div class="reset-button">
                                <button type="submit" name="update"value="Update Service" class="btn btn-success">Update</button>
