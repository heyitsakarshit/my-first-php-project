...
<body class="hold-transition sidebar-mini">
    ...
    <button type="button" name="add" id="add" class="btn btn-success"><i class="fa fa-plus"></i>Add New Services</button>
...
<!-- Mirrored from thememinister.com/crm/add-customer.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Oct 2020 05:58:19 GMT -->
   ...
   <div class="modal-body">
    <form id="image_form" method="post" enctype="multipart/form-data">
        ...
        <label for="symptom_name">Select Symptoms</label>
                                   ...
                                   <select name="symptom_name[]" class="form-control" id="symptom_name"  multiple="multiple">
                        <?php 
                    $con = mysqli_connect("localhost","drakpandey","Pandey@809","akpandey");   
                     $r="SELECT * FROM symptoms ;";
                        $rr = mysqli_query($con,$r);
                        while($row= mysqli_fetch_array($rr))
                        {
                            ?>
                    <option value="<?php echo $row['symptoms_name']; ?>"><?php echo $row['symptoms_name'];?></option> 
                            <?php
                        }
                        ?>
                    </select>
     ...
     <p><label>Service Name</label></p>
        <input type="text" name="name" class="form-control" placeholder="Enter Service Name" ><br />
           <p><label>Service Description</label>
           <textarea class="form-control" name="description"rows="3" ></textarea><br />
           
        <p><label style="margin:15px 0px;">Select Image</label>                      
...
$(document).ready(function(){
 ...
 $(document).on('click', '.delete', function(){
  ...
  var action = "delete";
  if(confirm("Are you sure you want to remove this data from database?"))
  {
   $.ajax({
    url:"serviceaction.php",
    method:"POST",
