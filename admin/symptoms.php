...
<body class="hold-transition sidebar-mini">
    ...
    <a href="addsymptom.php"><button type="button" name="addsymptom" id="addsymptom" class="btn btn-success"><i class="fa fa-plus"></i>Add Symptoms</button></a>
   </div>
   <br />
  ...
  <div class="modal-content">
   ...
   <div class="modal-body">
    <form id="image_form" method="post" enctype="multipart/form-data">
           ...
           <p><label>Symptoms Name</label>
           <input class="form-control" name="symptoms_name" id="image" required ><br />
...
$(document).ready(function(){
 ...
 $(document).on('click', '.update', function(){
  ...
  $('#action').val("update");
  $('.modal-title').text("Update Symptoms");
  $('#insert').val("Update");
  $('#imageModal').modal("show");
 });
